        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Positions_Genres_IdGenre",
                        column: x => x.IdGenre,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorPosition", x => new { x.AuthorsId, x.PositionsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WearoutStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Books", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Books_Positions_IdPosition",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_IdPosition",
                table: "Books",
                column: "IdPosition");

            migrationBuilder.CreateIndex(
                name: "IX_Positions_IdGenre",
                table: "Positions",
                column: "IdGenre");
        }
